...
/*=========== Sticky Header ===========*/
    function stickyHeader() {
        $(window).on("scroll", function () {
            var stickyMenu = $(".sticky__header");
            var pos = stickyMenu.position();
            if (stickyMenu.length) {
// ReSharper disable once UnusedLocals
                const windowpos = stickyMenu.top;
                $(window).on("scroll", function () {
...
/*========= Video ===========*/
    var videoFrameW= $(".img_static").outerWidth();
    var videoFrameH= $(".img_static").outerHeight();
    $("#cms_play").on("click", function(){
        $(this).hide("fast");
        $(".img_static").fadeOut("fast");
        $(".static_video").append(`<iframe class="added_video" width="${videoFrameW}px" height="${videoFrameH
