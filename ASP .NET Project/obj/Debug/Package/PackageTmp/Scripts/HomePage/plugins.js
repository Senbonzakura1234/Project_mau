        ...
        return this.each(function () {
            ...
            var M = "",
                ...
                b = function () {
                    ...
                    if (o >= a) {
                        jQuery(p).addClass("mean-remove"), E = !0, jQuery(t).addClass("mean-container"), jQuery(".mean-container").prepend(`<div class="mean-bar"><a href="#nav" class="meanmenu-reveal" style="${e
...
! function (a, b, c, d) {
    ...
    function (a, b, c, d) {
        ...
        e.Defaults = {
            ...
            this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), e = this._core.items(this._core.relative(e.index())), this._core.reset(e.index()), "youtube" === f.type ? c = `<iframe width="${g}" height="${h}" src="//www.youtube.com/embed/${f.id}?autoplay=1&rel=0&v=${f.id
                }" frameborder="0" allowfullscreen></iframe>` : "vimeo" === f.type ? c = `<iframe src="//player.vimeo.com/video/${f.id}?autoplay=1" width="${g}" height="${h
                    }" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>` : "vzaar" === f.type && (c = `<iframe frameborder="0"height="${h}"width="${g
                        }" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/${f.id
                        }/player?autoplay=true"></iframe>`), a(`<div class="owl-video-frame">${c}</div>`).insertAfter(e.find(".owl-video")), this._playing = e.addClass("owl-video-playing"))
                    ...
                    switch (e) {
                        ...
                        case "swf":
                            d = `<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="${
                                g}"></param>`, l = "", f.each(a.swf, function (a, b) {
